...
- (id)initWithLocation:(CGPoint)location andMaxRating:(NSInteger)maxRating andStarSize:(CGFloat)starSize andStarWidthAndHeight:(NSInteger)widthAndHeight
{
    return [self initWithLocation:location
                     ...
                     andMaxRating:maxRating
                      andStarSize:starSize
            andStarWidthAndHeight:widthAndHeight];
}
...
- (void)drawRect:(CGRect)rect
{
	...
	for (int i = 0; i < _rating; i++)
	{
		...
		else
        {
            ...
            [kDefaultSolidChar drawAtPoint:currPoint withFont:[UIFont boldSystemFontOfSize:_starSize]];
        }
	...
	for (int i = 0; i < remaining; i++)
	{
		...
		else
        {
			...
			[kDefaultEmptyChar drawAtPoint:currPoint withFont:[UIFont boldSystemFontOfSize:_starSize]];
        }
		currPoint.x += _starWidthAndHeight;
	}
}
 ...
 andStarWidthAndHeight:(NSInteger)widthAndHeight
{
                                              ...
                                              kStarWidthAndHeight)])
	{
        ...
        _starSize = starSize;
        _starWidthAndHeight = widthAndHeight;
	}
